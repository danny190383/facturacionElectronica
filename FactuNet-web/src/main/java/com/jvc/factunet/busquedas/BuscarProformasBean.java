...
@ManagedBean
@ViewScoped
public class BuscarProformasBean extends ImprimirReportesBean implements Serializable{
    ...
    {
        this.estado = "0";
        this.listaProformas.addAll(this.documentosServicios.listarProformas(this.empresa, this.estado));
    }
    ...
    public void filtrar()
    {
        this.listaProformas.clear();
        this.listaProformas.addAll(this.documentosServicios.listarProformasFiltro(empresa, numero, fecha, nombre, estado, ruc));
    }
    ...
    public void generarReporte(String tipoReporte, Integer documento) {
        try {
            ...
            super.getParametros().put("nombreReporte", "Proforma");
