...
@ManagedBean
@ApplicationScoped
public class CatalogosVeterinariaMovilBean extends ImprimirReportesMovilBean implements Serializable{
    ...
    private List<SexoMascota> listaSexoMascota;

    public CatalogosVeterinariaMovilBean() {
        this.listaEspecies = new ArrayList<>();
        this.listaRaza = new ArrayList<>();
        this.listaSexoMascota = new ArrayList<>();
    }
    
    @PostConstruct
    public void initCatalogosVeterinarios()
    {
        this.listaEspecies.addAll(this.especieMascotaServicio.listar());
        this.listaRaza.addAll(this.razaMascotaServicio.listar());
        this.listaSexoMascota.addAll(this.sexoMascotaServicio.listar());
    }
    ...
    public void refreshSexoMascota()
    {
        this.listaSexoMascota.clear();
        this.listaSexoMascota.addAll(this.sexoMascotaServicio.listar());
    }
    ...
    public List<SexoMascota> getListaSexoMascota() {
        this.refreshSexoMascota();
        return listaSexoMascota;
    }

    public void setListaSexoMascota(List<SexoMascota> listaSexoMascota) {
        this.listaSexoMascota = listaSexoMascota;
    }
