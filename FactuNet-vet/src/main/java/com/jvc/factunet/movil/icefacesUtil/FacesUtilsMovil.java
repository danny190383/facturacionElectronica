...
public class FacesUtilsMovil {
    ...
    public static ResourceBundle getResourceBundle() {
        return ResourceBundle.getBundle("com.jvc.factunet.movil.recursos.messages");
    }
    ...
    public static void redireccionar(final String url) {
        try {
            ...
            Logger.getLogger(FacesUtilsMovil.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
