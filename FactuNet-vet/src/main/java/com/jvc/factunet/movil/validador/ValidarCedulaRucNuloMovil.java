...
@FacesValidator("com.jvc.factunet.movil.validador.ValidarCedulaRucNuloMovil")
public class ValidarCedulaRucNuloMovil implements Validator, ClientValidator
{
    ...
    public static boolean validarCedulaRuc(String cedula_ruc) 
    {
        ...
        try 
        {
            ...
            {
                    FacesUtilsMovil.addErrorMessage("El número de documento ingresado no es valido (Cédula o RUC).");
                    cedula_ruc = "";
                    valor = false;
            }
            ...
            if (provincia <= 0 || provincia > numeroProvincias) 
            {
                    ...
                    FacesUtilsMovil.addErrorMessage("Cédula/Ruc incorrecto");
                    cedula_ruc ="";
                    valor = false;
            }
