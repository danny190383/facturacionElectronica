...
@Stateless
public class TipoTarjetaDAO extends GenericDAO{
    
    public List<TipoTarjeta> listar() {
        Query q = em.createQuery("select o from TipoTarjeta o ORDER BY o.nombre");
        return q.getResultList();
    }
    
    public List<TipoTarjeta> listarNombre(String nombre) {
        Query q = em.createQuery("select o from TipoTarjeta o "
